...
public class Review: NSManagedObject {
    static func createReview(id:String, movieName: String, releaseYear: Int64, genre: String, imageUrl: String, rating: Int64, review: String, userId:String , lastUpdated: Int64)-> Review {
